...
<div class="row">
    ...
    <div id="sub-title" class="large-6 medium-8 small-12 columns">
        ...
        <p>Tempestroad Board Games is a leading hobby game company based out of Orlando, Florida. We distribute a massive array of board and card games. Established in 1995, TempestRoad has earned a reputation for carrying  innovative  games with, immersive gaming experiences and industry-leading customer service.    </p>
        <br>
        <br>
        <ul class="roles">
            <li> Marineh - Back end development &amp; front end design  .</li>
            <li> Elaine  -  Company about.</li>
            <li> Matt E. - Test Cases, Validation</li>
            <li> Sung Oh - SEO, Company Policies. </li>
            <li> Daniel - Back end development, front end design &amp; security.</li>
            <li> Matt K - Search functionality.</li>
    ...
    <div id="s-info" class="large-6 medium-6 small-12 columns">
        ...
        <h4 class="h4">Contact</h4>
            <ul class="">
                    ...
                    <li><!--<a href="mailto:me@anydomainname.com">-->info@tempestroad.com<!--</a>--></li>
            </ul>
        </div>
      </div>
    </div>      
